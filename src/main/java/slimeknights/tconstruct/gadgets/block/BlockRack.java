...
public class BlockRack extends BlockTable {
  ...
  public static final PropertyEnum<EnumOrientation> ORIENTATION = PropertyEnum.<EnumOrientation>create("facing", EnumOrientation.class);
  ...
  public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list) {
    addBlocksFromOredict("slabWood", 0, list);
    addBlocksFromOredict("slabWood", 1, list);
  }
  ...
  protected BlockStateContainer createBlockState() {
    // FACING is used to orientate the item, while ORIENTATION is the location of the rack. This mainly affects centerized racks
